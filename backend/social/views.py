...
from .models import BlockedUser, Connection, ConnectionStatus, Profile
...
class BlockListView(APIView):
    ...
    def post(self, request):
        ...
        Connection.objects.filter(
            models.Q(from_user=request.user, to_user=target) | models.Q(from_user=target, to_user=request.user)
        ).delete()
