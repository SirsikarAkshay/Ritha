...
from .factories import CulturalRuleFactory, LocalEventFactory, UserFactory
...
class TestCulturalRules:
    def test_list_rules(self, client):
        ...
        CulturalRuleFactory(
            country="Italy", city="Rome", rule_type="cover_shoulders", description="Shoulders covered in Vatican"
        )
        user = UserFactory()
