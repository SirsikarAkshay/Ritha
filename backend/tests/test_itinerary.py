...
from .factories import CalendarEventFactory, TripFactory, UserFactory
...
class TestCalendarEvents:
    ...
    def test_filter_events_by_date(self, client):
        ...
        CalendarEventFactory(
            user=user,
            title="Today",
            start_time=datetime.datetime(2026, 3, 14, 9, 0, tzinfo=datetime.UTC),
            end_time=datetime.datetime(2026, 3, 14, 10, 0, tzinfo=datetime.UTC),
        )
        CalendarEventFactory(
            user=user,
            title="Tomorrow",
            start_time=datetime.datetime(2026, 3, 15, 9, 0, tzinfo=datetime.UTC),
            end_time=datetime.datetime(2026, 3, 15, 10, 0, tzinfo=datetime.UTC),
        )
        h = auth_header(client, user)
