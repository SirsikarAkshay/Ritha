...
class TestOutlookConnect:
    ...
    @patch(
        "calendar_sync.outlook_calendar.get_authorization_url",
...
class TestOutlookSync:
    ...
    @patch("calendar_sync.outlook_calendar.sync_events", return_value={"created": 4, "updated": 2, "errors": []})
