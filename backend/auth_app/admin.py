...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        (
            "Google Calendar",
            {"fields": ("google_calendar_connected", "google_calendar_email", "google_calendar_synced_at")},
        ),
        (
            "Apple Calendar",
            {"fields": ("apple_calendar_connected", "apple_calendar_username", "apple_calendar_synced_at")},
        ),
        (
            "Outlook Calendar",
            {"fields": ("outlook_calendar_connected", "outlook_calendar_email", "outlook_calendar_synced_at")},
        ),
