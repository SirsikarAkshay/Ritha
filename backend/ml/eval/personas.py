...
def cold_business_day() -> Persona:
    ...
    wardrobe = [
        ...
        _item(
            4, "Black leather oxfords", "footwear", formality="formal", season="all", colors=["black"], times_worn=10
        ),
...
def rainy_commute() -> Persona:
    ...
    wardrobe = [
        ...
        _item(
            2, "Waterproof shell", "outerwear", formality="casual", season="all", colors=["black"], tags=["waterproof"]
        ),
        ...
        events=[
            {
                ...
                "start_time": "2026-04-29T06:00:00",
                "location": "Gym",
            },
            {
                "title": "Client call",
            ...
            },
            {
                ...
                "event_type": "social",
                "formality": "casual_smart",
                "start_time": "2026-04-29T19:00:00",
                "location": "Restaurant",
            },
        ],
...
def compound_cultural_rules() -> Persona:
    ...
    cultural_rules = [
        {
            "type": "cover_shoulders",
            "severity": "required",
            "description": "Shoulders must be covered in religious sites.",
        },
        {"type": "cover_knees", "severity": "required", "description": "Knees must be covered."},
        {"type": "no_bare_feet", "severity": "required", "description": "No open-toe footwear in temples."},
    ]
    wardrobe = [
        _item(
            1,
...
def freezing_with_summer_wardrobe() -> Persona:
    ...
    wardrobe = [
        _item(
            1, "White cotton tee", "top", formality="casual", season="summer", colors=["white"], tags=["short sleeve"]
        ),
...
def cultural_filter_eliminates_wardrobe() -> Persona:
    ...
    wardrobe = [
        ...
        _item(
            5, "Strapless dress", "dress", formality="casual_smart", season="summer", colors=["red"], tags=["strapless"]
        ),
